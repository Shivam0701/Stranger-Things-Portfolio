...
const ContactSection = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Your transmission from the other side has been captured. I'll respond soon!",
        duration: 5000,
      });
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: 'url(https://images.unsplash.com/photo-1628763448808-9433311579e5)',
    ...
    >
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {/* Contact Info */}
          <div className={`contact-info ${isVisible ? 'fade-in-up delay-200' : 'opacity-0'}`}>
            <h3 className="text-3xl font-bold text-red-400 mb-6">CONNECT WITH ME</h3>
          ...
          {/* Contact Form */}
          <div className={`contact-form-wrapper ${isVisible ? 'fade-in-up delay-400' : 'opacity-0'}`}>
            <h3 className="text-3xl font-bold text-red-400 mb-6">SEND A MESSAGE</h3>
